 ...
 * 
 */
@WebServiceClient(name = "MiServicioWeb", targetNamespace = "http://miservicioweb/", wsdlLocation = "http://localhost:8080/MisWebservice/MiServicioWeb?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/MisWebservice/MiServicioWeb?WSDL");
