...
public interface MiServicioWeb {
    ...
    @RequestWrapper(localName = "multiplica", targetNamespace = "http://miservicioweb/", className = "miservicioweb.Multiplica")
    @ResponseWrapper(localName = "multiplicaResponse", targetNamespace = "http://miservicioweb/", className = "miservicioweb.MultiplicaResponse")
    @Action(input = "http://miservicioweb/MiServicioWeb/multiplicaRequest", output = "http://miservicioweb/MiServicioWeb/multiplicaResponse", fault = {
        @FaultAction(className = Exception_Exception.class, value = "http://miservicioweb/MiServicioWeb/multiplica/Fault/Exception")
    })
